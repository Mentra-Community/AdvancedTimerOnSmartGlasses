...
export class StopwatchUi {
    constructor(
        ...
        private getStatusTextForTitle(state: MyAppState.STOPWATCH_READY | MyAppState.STOPWATCH_RUNNING | MyAppState.STOPWATCH_PAUSED | MyAppState.STOPWATCH_STOPPED | MyAppState.STOPWATCH_AUTOLAP_COMPLETED ): string {
        switch (state) {
    ...
    public displayInterface(
        ...
        state: MyAppState.STOPWATCH_READY | MyAppState.STOPWATCH_RUNNING | MyAppState.STOPWATCH_PAUSED | MyAppState.STOPWATCH_STOPPED | MyAppState.STOPWATCH_AUTOLAP_COMPLETED
        ): void {
        ...
        if (contextText) displayText += `${contextText}\n`;
    ...
    public displayScore(
        ...
        let scorePrompt = ""; 
        const showHintsLevel = sessionInfo.currentSettings.show_hints_level as ShowHintsLevel;
